...
# --- 天気取得 ---
lat_lon_map = {
    "01": (36.39788, 139.30829), "02": (35.80392, 139.65788), "03": (35.69261, 139.86140),
    "04": (35.58604, 139.73880), "05": (35.65809, 139.49709), "06": (34.69834, 137.57228),
    "07": (34.82328, 137.20463), "08": (34.88568, 136.83239), "09": (34.68174, 136.52186),
    "10": (36.23268, 136.18543), "11": (35.01859, 135.86132), "12": (34.61058, 135.47133),
    "13": (34.71956, 135.39393), "14": (34.19084, 134.60947), "15": (34.30470, 133.79581),
    "16": (34.44886, 133.80914), "17": (34.31498, 132.30650), "18": (34.01065, 131.83541),
    "19": (34.01904, 131.00411), "20": (33.88706, 130.76448), "21": (33.87399, 130.66467),
    "22": (33.59914, 130.39694), "23": (33.42415, 129.99576), "24": (32.89654, 129.95146),
}
...
if (
    ...
    map_url = f"https://www.google.com/maps?q={lat},{lon}&hl=ja&z=14&output=embed"

    # iframeで埋め込み表示（横幅100%、高さ400px）
    components.iframe(map_url, width=700, height=400)
...
input_url = st.text_input("出走表のURLを入力してください", value=detail_url)
